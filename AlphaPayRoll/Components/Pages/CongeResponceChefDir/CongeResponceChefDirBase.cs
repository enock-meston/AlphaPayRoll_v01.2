...
namespace AlphaPayRoll.Components.Pages.CongeResponceChefDir
{
    public class CongeResponceChefDirBase : ComponentBase
    {
        [Inject]
            ...
            try
            {
                ...
                if (DateFrom.HasValue && DateTo.HasValue)
                {
                    if (FilterValue=="Validated")
                    {
                        ...
                        .Where(x => (x.ChefID == userId) && (x.CreatOn >= DateFrom.Value.Date
