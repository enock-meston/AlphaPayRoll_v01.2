    ...
    public class TSL550TPHSupBasePage : ComponentBase
    {
        ...
        protected void ShowPopUp(int tPAction)
        {
            ...
            else if (tPAction == 3)
            {
                ...
                oOneTSL550TPHSup.LModifBy = int.Parse(osessionService.UserId);
            ...
            if (tPAction == 1)
            {
                ...
                oOneTSL550TPHSup.CreatBy = int.Parse(osessionService.UserId);
        ...
        protected async Task SaveTSL550TPHSup(ClassTSL550TPHSup item)
        {
            ...
            try
            {
                ...
                oOneTSL550TPHSup.UserID = int.Parse(osessionService.UserId);
