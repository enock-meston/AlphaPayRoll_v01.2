...
{
    public class ListCaisseEpargneBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListCaisseEpargne oListBourseService { set; get; }
        ...
        public List<ListCaisseEpargne> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                oReportList = oReportList2.Where(row => row.OrdNum == pModuleID).ToList();
                SalaireList = await oListBourseService.GetListCaisseEpargne();
