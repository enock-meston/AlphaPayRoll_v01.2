...
{
    public class ListePrimeAgentComBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListePrimeAgentCom oListPayByBranchService { set; get; }
        ...
        public List<ListePrimeAgentCom> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                SalaireList = await oListPayByBranchService.GetListePrimeAgentCom();
