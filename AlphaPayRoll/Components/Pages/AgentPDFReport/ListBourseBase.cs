...
{
    public class ListBourseBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListBourse oListBourseService { set; get; }
        ...
        public List<ListBourse> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                oReportList = oReportList2.Where(row => row.OrdNum == pModuleID).ToList();
                SalaireList = await oListBourseService.GetListBourse();
