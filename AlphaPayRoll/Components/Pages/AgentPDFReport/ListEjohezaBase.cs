...
{
    public class ListEjohezaBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListEjoheza oListEjohezaService { set; get; }
        ...
        public List<ListEjoheza> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                SalaireList = await oListEjohezaService.GetListEjohezas();
