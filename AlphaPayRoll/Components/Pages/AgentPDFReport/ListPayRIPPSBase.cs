...
{
    public class ListPayRIPPSBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListPayRIPPS oListBourseService { set; get; }
        ...
        public List<ListPayRIPPS> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                oReportList = oReportList2.Where(row => row.OrdNum == pModuleID).ToList();
                SalaireList = await oListBourseService.GetListPayRIPPS();
