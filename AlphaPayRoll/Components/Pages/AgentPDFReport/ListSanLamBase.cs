...
{
    public class ListSanLamBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListSanLam oListSanLamService { set; get; }
        ...
        public List<ListSanLam> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                SalaireList = await oListSanLamService.GetListSanLam();
