...
{
    public class ListRetCaisSolidBase : ComponentBase
    {
        [Inject]
        ...
        [Inject]
        protected IListRetCaisSolid oListBourseService { set; get; }
        ...
        public List<ListRetCaisSolid> SalaireList { get; set; } = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                oReportList = oReportList2.Where(row => row.OrdNum == pModuleID).ToList();
                SalaireList = await oListBourseService.GetListRetCaisSolid();
