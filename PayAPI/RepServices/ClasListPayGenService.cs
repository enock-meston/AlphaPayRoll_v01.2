...
namespace PayAPI.RepServices
{
    ...
    public interface IListPayGenService
    {
        Task<byte[]> GenerateRepListPayAsync(string reportName, string reportType);


    }
    public class ClasListPayGenService : IListPayGenService
    {
        private readonly string connectionString;
        public ClasListPayGenService(IConfiguration configuratrion)
        {
        ...
        public async Task<byte[]> GenerateRepListPayAsync(string reportName, string reportType)
        {
            ...
            using (IDbConnection oCon = new SqlConnection(connectionString))
            {
                ...
                var List = await oCon.QueryAsync<LstPaieConsolid>("Ps_ListPayGen", commandType: CommandType.StoredProcedure);
