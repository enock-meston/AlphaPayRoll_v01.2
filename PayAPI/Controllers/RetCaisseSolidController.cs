...
namespace PayAPI.Controllers
{
    ...
    [ApiController]
    public class RetCaisseSolidController : ControllerBase
    {

        private readonly IRetCaisseSolidService oImplement;
        public RetCaisseSolidController(IRetCaisseSolidService implement)
        {
