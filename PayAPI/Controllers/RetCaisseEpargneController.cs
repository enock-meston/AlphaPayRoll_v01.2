...
namespace PayAPI.Controllers
{
    ...
    [ApiController]
    public class RetCaisseEpargneController : ControllerBase
    {

        private readonly IRetCaisseEpargneService oImplement;
        public RetCaisseEpargneController(IRetCaisseEpargneService implement)
        {
        ...
        {
            var reportFile = await oImplement.GenerateListAsync(reportName, reportType);
