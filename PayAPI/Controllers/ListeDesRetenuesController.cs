...
namespace PayAPI.Controllers
{
    ...
    [ApiController]
    public class ListeDesRetenuesController : ControllerBase
    {

        private readonly IListRetenueService oImplement;
        public ListeDesRetenuesController(IListRetenueService implement)
        {
        ...
        {
            var reportFile = await oImplement.GenerateRepListRetenueAsync(reportName, reportType);
