...
namespace PayAPI.Controllers
{
    ...
    public class ListPayConsolidController : ControllerBase
    {
        ...
        private readonly IListPayGenService oImplement;
        public ListPayConsolidController(IListPayGenService implement)
        {
        ...
        {
            var reportFile = await oImplement.GenerateRepListPayAsync(reportName, reportType);
