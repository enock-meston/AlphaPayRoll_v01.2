...
namespace PayAPI.Controllers
{
    ...
    [ApiController]
    public class RetEjoHezaController : ControllerBase
    {


        private readonly IRetEjohezaService oImplement;
        public RetEjoHezaController(IRetEjohezaService implement)
        {
