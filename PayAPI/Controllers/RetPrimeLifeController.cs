...
namespace PayAPI.Controllers
{
    ...
    [ApiController]
    public class RetPrimeLifeController : ControllerBase
    {

        private readonly IRetPrimeLifeService oImplement;
        public RetPrimeLifeController(IRetPrimeLifeService implement)
        {
