...
namespace PayAPI.Controllers.AgRetCotisation
{
    [Route("api/[controller]")]
    [ApiController]
    public class TSL02AgRetCotisController : ControllerBase
    {
        private readonly ITSL02AgRetCotis oImplement;
        public TSL02AgRetCotisController(ITSL02AgRetCotis implement)
        {
        ...
        {
            return await oImplement.GetTSL02AgRetCotisByAgent(id);
        }
